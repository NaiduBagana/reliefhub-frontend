  ...
  const banners = [
    {
      ...
      link: "/calamities",
      description:
        "Get real-time updates on ongoing calamities, including their type, location, and severity. Stay one step ahead with our comprehensive disaster information.",
    },
    {
      id: 2,
      right: true,
      ...
      link: "/resources",
      description:
        "Access a wide range of essential resources, from medical equipment to transportation, to effectively respond to calamities. Ensure you have the tools you need when it matters most.",
    },
    {
      id: 3,
      right: false,
