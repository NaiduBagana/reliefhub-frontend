...
const Calamities = () => {
  ...
  const [filteredCalamities, setFilteredCalamities] = useState([]);
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        setCalamities(response.calamities);
        setLoading(false);
      } catch (error) {
        toast.error("Error fetching calamities");
        console.error(error);
        setLoading(false);
      }
    };
  ...
  useEffect(() => {
    // Filter calamities based on severity, state, and status
    ...
    setFilteredCalamities(filtered);
  }, [severityFilter, stateFilter, statusFilter, calamities]);
      ...
      <div className="w-11/12 flex flex-col items-center justify-center">
        ...
        <div className="w-8/12 mt-6 mb-4">
          ...
          <input
            ...
            placeholder="Search any Calamity Info...."
